		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "google map",
									"targetURL": "#comexamplegooglemap-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comexamplegooglemap-display": {
								"semanticObject": "comexamplegooglemap",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.example.googlemap",
									"url": sap.ui.require.toUrl("com/example/googlemap")
								}
							}
						}
					}
